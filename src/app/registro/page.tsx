...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <div className="min-h-[calc(100vh-80px)] bg-[#F9F8F6] flex items-center justify-center py-20 px-4">
        <ScrollAnimation className="relative z-10 w-full max-w-md">
          <div className="bg-white p-10 shadow-xl border border-black/5 rounded-sm text-center">
            <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <h2 className="text-2xl font-serif font-bold text-[#111] mb-3">¡Revisa tu email!</h2>
            ...
            <Link
              href="/login"
              className="inline-block w-full bg-[#111] text-white py-4 text-sm font-bold hover:bg-[#333] transition-colors"
            >
              Ir a Iniciar Sesión
            </Link>
          </div>
      ...
      <ScrollAnimation className="relative z-10 w-full max-w-md">
        <div className="bg-white p-10 shadow-xl border border-black/5 rounded-sm">
          ...
          <div className="flex flex-col items-center mb-10 text-center">
            <h1 className="text-3xl font-serif font-bold text-[#111] mb-2">{t("register.welcome")}</h1>
            <p className="text-[#666] text-sm">{t("register.desc")}</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 h-12 border border-black/20 text-[#111] font-medium text-sm hover:bg-black/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
            ...
            <form className="space-y-5" onSubmit={handleRegister}>
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-wider text-[#111] mb-2" htmlFor="name">
                  {t("register.name")}
                </label>
                <input
                  id="name"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder={t("register.passPlace")}
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-wider text-[#111] mb-2" htmlFor="confirmPassword">
                ...
                <input
                  ...
                  className={`w-full border-b pb-2 text-sm outline-none transition-colors bg-transparent ${
                    confirmPassword && confirmPassword !== password
                      ...
                      : "border-black/20 focus:border-[#8A6D3B]"
                  }`}
                  required
                />
                {confirmPassword && confirmPassword !== password && (
              ...
              <button
                ...
                className="w-full bg-[#111] text-white py-4 text-sm font-bold flex items-center justify-center gap-2 hover:bg-[#333] transition-colors mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
              >
